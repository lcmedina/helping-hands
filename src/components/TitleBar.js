        ...
        >
          ...
          <Offcanvas.Body>
            <Nav className="justify-content-end flex-grow-1 pe-3 navigation">
              <Container>
              <Nav.Link href="#action1"><img src={Home} width={50} height={50} /> Home</Nav.Link>
              </Container>
              {/* donate dropdown */}
              <Container style={{display: 'flex'}}>
                <img src={Donate} width={50} height={50} />
              ...
              {/* recieve dropdown */}
              <Container style={{display: 'flex'}}>
              <img src={Receive} width={50} height={50} />
              ...
              {/* translate dropdown */}
              <Container style={{display: 'flex'}}>
              <img src={Translate} width={50} height={50} />
